  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        <ArrowsVertical size={32} weight="duotone" />
        <div>
          <h1 className="font-bold text-3xl">Flip Image</h1>
          <p className="text-muted-foreground">Flip image vertically</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Flip Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /flip endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
