...
export const Route = createFileRoute("/autorotate")({
  component: AutoRotateComponent,
});
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-3xl">Auto Rotate</h1>
          <p className="text-muted-foreground">
            Automatically rotate image based on EXIF orientation metadata
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Auto Rotate Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /autorotate endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              >
                {isProcessing ? "Processing..." : "Auto Rotate Image"}
              </Button>
            </CardContent>
          </Card>
        </div>
