...
function ZoomComponent() {
  ...
  // Transform params
  const [nocrop, setNocrop] = useState(true);
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-3xl">Zoom Image</h1>
          <p className="text-muted-foreground">Zoom image by factor</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Zoom Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /zoom endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs className="w-full" defaultValue="basic">
                ...
                <TabsContent className="space-y-4" value="basic">
                  <FactorParam onChange={setFactor} value={factor} />
              ...
              >
                {isProcessing ? "Processing..." : "Zoom Image"}
              </Button>
            </CardContent>
          </Card>
        </div>
