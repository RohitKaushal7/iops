...
export const Route = createFileRoute("/enlarge")({
  component: EnlargeComponent,
});

function EnlargeComponent() {
  ...
  const handleProcess = async () => {
    ...
    if (nocrop) params.nocrop = nocrop;
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        <ArrowsOutSimple size={32} weight="duotone" />
        <div>
          <h1 className="font-bold text-3xl">Enlarge Image</h1>
          <p className="text-muted-foreground">
            Enlarge image to specific dimensions
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Enlarge Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /enlarge endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Tabs className="w-full" defaultValue="basic">
                ...
                <TabsContent className="space-y-4" value="basic">
                  ...
                  <div className="space-y-3">
                    <NoCropParam onChange={setNocrop} value={nocrop} />
