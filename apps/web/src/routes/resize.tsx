  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        <ArrowsOut size={32} weight="duotone" />
        <div>
          <h1 className="font-bold text-3xl">Resize Image</h1>
          <p className="text-muted-foreground">
            Resize image by width or height. Image aspect ratio is maintained
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Resize Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /resize endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
