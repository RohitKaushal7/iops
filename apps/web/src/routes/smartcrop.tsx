...
export const Route = createFileRoute("/smartcrop")({
  component: SmartCropComponent,
});

function SmartCropComponent() {
  ...
  const [gravity, setGravity] = useState("smart");
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="font-bold text-3xl">Smart Crop</h1>
          <p className="text-muted-foreground">
            Intelligent crop using libvips built-in algorithm
          </p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Smart Crop Parameters</CardTitle>
              <CardDescription>
                All parameters supported by the /smartcrop endpoint
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              >
                {isProcessing ? "Processing..." : "Smart Crop Image"}
              </Button>
            </CardContent>
          </Card>
        </div>
